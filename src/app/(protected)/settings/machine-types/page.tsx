...
import { toggleMachineType } from '@/features/settings/actions';
import { MachineTypeForm } from '@/features/settings/components/machine-type-form';
import { getMachineCategories, getMachineTypes } from '@/features/settings/queries';
  ...
  return (
    <PageContainer title="Types machine">
      <div className="space-y-4">
        ...
        {types.length === 0 ? (
          <PlaceholderState message="Aucun type machine configuré." />
        ) : (
