...
import { upsertMachineCategory } from '@/features/settings/actions';
import { machineCategorySchema, type MachineCategoryValues } from '@/features/settings/schemas';
import type { MachineCategorySetting } from '@/types/settings';

export function MachineCategoryForm({ category }: { category?: MachineCategorySetting }) {
